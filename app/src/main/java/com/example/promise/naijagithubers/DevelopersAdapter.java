...
public class DevelopersAdapter extends RecyclerView.Adapter<DevelopersAdapter.ViewHolder> {
    ...
    public DevelopersAdapter(List<DevelopersList> developersLists, Context context){
        ...
        //general constructors to initialise the list and context object
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        //this method will bind the data to the ViewHolder from when it will be shown on other views
    ...
    //return the size of listItem (developersList)
