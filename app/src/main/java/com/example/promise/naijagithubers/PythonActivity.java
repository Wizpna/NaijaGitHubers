...
/**
 * Created by Promise on 11/16/2017.
 */

public class PythonActivity extends AppCompatActivity {

    private static final String URL_DATA = "https://api.github.com/search/users?q=language:python+location:nigeria";
    ...
    private void loadUrlData(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_DATA, new Response.Listener<String>(){
            ...
            public void onErrorResponse(VolleyError error){
                Toast.makeText(PythonActivity.this, "Error" + error.toString(), Toast.LENGTH_SHORT).show();
            }
        });
